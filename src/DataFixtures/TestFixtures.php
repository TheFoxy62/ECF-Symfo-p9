...
class TestFixtures extends Fixture
{
    ...
    {
        $respository = $this->doctrine->getRepository(Auteur::class);
        $auteurs = $respository->findAll();

        $respository = $this->doctrine->getRepository(Genre::class);
        $genres = $respository->findAll();
